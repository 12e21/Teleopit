...
├── legged_gym/               # Isaac Lab environments (migrated from IsaacGym)
│   ├── __init__.py           # TELEOPIT_TRAIN_ROOT_DIR computation
│   ├── envs/
│   │   ├── base/             # Base environment classes
│   │   │   ├── base_task.py, humanoid.py, humanoid_char.py, humanoid_mimic.py
│   │   │   └── *_config.py
│   │   └── g1/              # G1 robot environments
│   │       ├── g1_mimic.py, g1_mimic_distill.py, g1_mimic_future.py
│   │       └── *_config.py
│   ├── gym_utils/            # Helpers, math, terrain, task_registry
│   ├── scripts/              # train.py, play.py, save_onnx.py
│   └── motion_data_configs/  # Dataset YAML manifests
├── rsl_rl/                   # RL algorithms (PPO, DAgger)
│   ├── algorithms/           # ppo.py, dagger.py, dagger_ppo.py
│   ├── modules/              # ActorCritic, ActorCriticFuture, etc.
│   ├── runners/              # OnPolicyRunner, DAggerRunner, etc.
│   ├── datasets/             # MotionLoader, pose3d
│   ├── storage/              # RolloutStorage, ReplayBuffer
│   └── utils/                # Normalizer, RunningMeanStd, etc.
├── pose/                     # Motion library (poselib)
│   ├── poselib/              # Rotation3D, SkeletonMotion
│   └── utils/                # MotionLib, torch_utils
└── assets/
    └── g1/                   # Isaac Lab URDF + meshes
```
